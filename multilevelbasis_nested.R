...
# multilevelbasis_nested.m
# 20201221 Xiaoyang Chen
# 20210218 edit to nested function
...
multilevelbasis_nested<-function(tree,coords,degree,polymodel,mt){
  ...
  return(list('multileveltree'=transformcell,'ind'=ind, 'datacell'=cl$datacell, 'datalevel'=cl$datalevel))
}